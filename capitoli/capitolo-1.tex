...
\section{L'azienda}
\AD{} è una \markg{\gls{startup}} nata nel 2014, dall'idea di tre giovani padovani, Carlo Pasqualetto, Jacopo Pertile e Antonio Fornari, con l'intento di assistere le aziende nel miglioramento e nella digitalizzazione dei propri processi interni.\\
...
Vista la grossa richiesta di AWMS da parte di importanti aziende nazionali ed internazionali, nel 2019 i tre soci decidono di dare vita ad \textbf{I4.0Saas}, uno \markg{\textit{\gls{spin-off}}} di \AD{}, che a partire dal 2020 si occuperà esclusivamente della gestione e dello sviluppo del progetto AWMS.\\
...
Un altro pilastro fondante di \AD{} è il concetto di \textbf{Squadra}: non è raro infatti, che vengano effettuate delle sessioni di \markg{\textit{\gls{brainstorming}}} tra tutto il personale per trovare idee innovative o soluzioni a problematiche riscontrate nei vari progetti.\\
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\begin{figure}[h]
\includegraphics[width=\textwidth, keepaspectratio]{d-d-dt-medium-com.png}
\centering
...
Il processo di trasformazione digitale avviene tramite la successione di tre fasi distinte: 
\begin{itemize}
...
\AD{} inoltre sviluppa anche piattaforme \markg{\textit{\acrshort{saas}}} verticali, ovvero soluzioni software basate sul \markg{\textit{\gls{cloud}}} completamente gestite:
...
Questo reparto ha il compito di sviluppare il prodotto, definendo ed implementando tutte le caratteristiche accordate con il cliente, sia a livello logico (\markg{\textit{\gls{back-end}}}) che a livello visuale (\markg{\textit{\gls{front-end}}}). Fa parte di questo reparto anche la figura del designer, che ha il compito di definire l'interfaccia utente alla quale poi gli sviluppatori dovranno far riferimento;  
...
Nello specifico, viene seguito il \markg{\textit{\gls{framework}}} Scrum, sintetizzato in figura \ref{fig:scrum}.
...
\label{fig:scrum}
\end{figure}
\AD{} ha deciso di adottare la metodologia Agile per lo sviluppo software in quanto permette all'azienda di essere molto elastica rispetto ad eventuali cambiamenti dei requisiti iniziali, oltre che a permettere il \markg{\textit{\gls{deployment}}} di un prodotto testabile al termine di ogni Sprint, così da avere un \markg{\textit{\gls{feedback}}} sul prodotto nel minor tempo possibile ed agire tempestivamente su modifiche o correzioni di errori.  
